...
MY_APPS = ["courses", "accounts", "contents", "students_courses"]
...
""" db_from_url = dj_database_url.config(
    default="postgres://jhona:209151@localhost:5432/projeto_final_m5s6"
) """
...
if DATABASE_URL:
    ...
    # duvida esse ".update serve para atualizar/dar um novo valor para qlq lista?"
    DEBUG = False
